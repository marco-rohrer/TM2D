...
!       PRINT*,"--debug [Print debug information]"
        ...
        PRINT*,"--mode=CHAR [Indicate blocking mode: {TM2D,DG83,VAPV}]"
        PRINT*,"--persistence=INT [# timesteps for persistence, required for TM2D,DG83,VAPV][20]"
        PRINT*,"--overlap=FLOAT [required spatial overlap, required for TM2D,DG83,VAPV][0.7]"
